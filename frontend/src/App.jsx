...
function getHistoryPrediction(scan) {
  ...
  const candidates = [
    scan?.static_analysis?.ml_engine?.prediction,
    scan?.detection?.verdict,
    scan?.prediction,
    scan?.classification,
    scan?.malware_verdict,
    scan?.ml_prediction,
    scan?.ml_result?.prediction,
    scan?.analysis?.prediction,

    resultObject?.static_analysis?.ml_engine?.prediction,
    resultObject?.detection?.verdict,
    resultObject?.prediction,
    resultObject?.classification,
    resultObject?.malware_verdict,
    resultObject?.ml_prediction,
    resultObject?.ml_result?.prediction,
    resultObject?.analysis?.prediction
  ]
...
function getHistoryTimestamp(scan) {
  ...
  const candidates = [
    ...
    scan?.time,
    scan?.file?.timestamp,
    scan?.file?.created_at,
    scan?.file?.uploaded_at,
    scan?.metadata?.timestamp,
    scan?.metadata?.created_at,
    scan?.analysis?.timestamp,
    scan?.scan?.timestamp,

    resultObject?.timestamp,
    resultObject?.scan_timestamp,
    resultObject?.scan_time,
    resultObject?.analysis_timestamp,
    resultObject?.analysis_time,
    resultObject?.scanned_at,
    resultObject?.scannedAt,
    resultObject?.completed_at,
    resultObject?.completedAt,
    resultObject?.created_at,
    resultObject?.createdAt,
    resultObject?.uploaded_at,
    resultObject?.uploadedAt,
    resultObject?.date,
    resultObject?.time
  ]
...
function App() {
  ...
  const [themeMode, setThemeMode] = useState(
    () =>
      localStorage.getItem('threatlens-theme') ||
      'light'
  )

  const [deviceMode, setDeviceMode] = useState(
    () =>
      localStorage.getItem('threatlens-device') ||
      'desktop'
  )
  ...
  const handleFileChange = (e) => {
    ...
    if (!isExe) {
      ...
      setFileError(
        'Please select a Windows executable (.exe) file.'
      )
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const scanResponse =
        await uploadAndScanFile(selectedFile)
  ...
  return (
    <div
      className={`app-shell device-${deviceMode}`}
    >
      {page === 'login' && (
        <div className="login-page">
          ...
          <main className="login-card">
            ...
            <p className="login-subtitle">
              Sign in to access your secure malware
              analysis workspace
            </p>
            ...
            <button
              type="button"
              className="secondary-button create-account-button"
              onClick={() => {
                setLoginError('')
                setLoginSuccess('')
                setPage('register')
          ...
          <footer>
            ThreatLens AI • Malware Detection &
            Analysis Platform
          </footer>
        </div>
      )}
...
function RegisterPage({
  ...
  const [username, setRegisterUsername] =
    useState('')
  const [email, setEmail] = useState('')
  const [password, setRegisterPassword] =
    useState('')
  const [confirmPassword, setConfirmPassword] =
    useState('')
  const [role, setRegisterRole] =
    useState('Security Analyst')
  ...
  return (
    <div className="login-page">
      ...
      <main className="login-card register-card">
        ...
        <p className="login-subtitle">
          Create your secure ThreatLens AI analyst account
        </p>
        ...
        <div className="secure-note">
          🔒 Your account is protected by ThreatLens AI authentication
        </div>
      </main>
        ...
        <header className="dashboard-header">
          <div>
            ...
            <p className="welcome-text">
              Monitor and analyze suspicious
              files from one workspace.
            </p>
          </div>
        ...
        <section className="quick-analysis">
          <div>
            ...
            <div>
              ...
              <p>
                Upload an executable and let
                ThreatLens AI analyze it.
              </p>
            </div>
          </div>
...
function UploadPage({
  ...
  const mlResult =
    analysisResult?.ml || null

  const yaraResult =
    analysisResult?.yara || null

  const fileResult =
    analysisResult?.file || null

  const engineResult =
    analysisResult?.engine || null
  ...
  const prediction =
    mlResult?.prediction || 'PENDING'

  const riskLevel =
    mlResult?.risk_level || 'PENDING'

  const scanStatus =
    analysisResult?.scan_status ||
    'PENDING'
    ...
    <div className="upload-page">
      ...
      <main className="upload-content">
        ...
        <p className="upload-description">
          Upload an executable file for static
          malware analysis.
        </p>
        ...
        <div className="upload-card">
          ...
          <p>
            Select a Windows executable (.exe)
          ...
          <small className="security-warning">
            🔒 Files are submitted to the
            ThreatLens AI backend for ML and
            YARA analysis.
          </small>
        </div>
        ...
        {isAnalyzing && (
          <div className="analysis-progress">
            ...
            <div>
              <strong>
                Running ML/YARA analysis
              </strong>

              <p>
                ThreatLens AI is analyzing the
                executable. Please wait...
              </p>
            </div>
          </div>
        )}
...
function HistoryPage({
  ...
  const getPrediction = (scan) =>
    getHistoryPrediction(scan)

  const getRiskLevel = (scan) => {
    const mlRisk =
      scan?.static_analysis
        ?.ml_engine?.risk_level ||
      scan?.risk_level
      ...
      <main className="dashboard-content">
        <header className="dashboard-header">
          <div>
            ...
            <p className="welcome-text">
              Review previous malware analysis
        ...
        <section className="panel">
          ...
          {isLoading ? (
            ...
            <div className="empty-state">
              ...
              <p>
                Analyze an executable file to
                create your first scan record.
              </p>
    ...
    useState([
      {
        ...
        severity: 'Critical',
        title:
          'Malware detected in sample.exe',
        description:
      ...
      },
      {
        ...
        severity: 'High',
        title:
          'Potentially malicious file identified',
        description:
      ...
      },
      {
        ...
        severity: 'Low',
        title:
          'Benign file analysis completed',
        description:
      ...
      <main className="dashboard-content">
        <header className="dashboard-header">
          <div>
            ...
            <p className="welcome-text">
              Monitor important threat detections
              and security events.
            </p>
          </div>
      ...
      <main className="dashboard-content">
        <header className="dashboard-header">
          <div>
            ...
            <p className="welcome-text">
              Understand malware detection trends
        ...
        <section className="quick-analysis">
          <div>
            ...
            <div>
              ...
              <p>
                Analyze another executable to
                expand your security insights.
              </p>
            </div>
          </div>
...
function SettingsPage({
  ...
  const themeOptions = [
    [
      ...
      '☀',
      'Light',
      'Bright blue and white workspace'
    ],
    [
      'dark',
      '◐',
      'Dark',
      'Low-light blue security workspace'
    ],
    [
      'system',
      '◌',
  ...
  const deviceOptions = [
    [
      ...
      '▣',
      'Desktop',
      'Full-width workstation layout'
    ],
    [
      'tablet',
      '▤',
      'Tablet',
      'Compact medium-screen layout'
    ],
    [
      'mobile',
      '▯',
      ...
      <main className="dashboard-content settings-page">
        <header className="dashboard-header page-header">
          <div>
            ...
            <p className="welcome-text">
              Customize the ThreatLens AI
              workspace appearance and device
              layout.
            </p>
          </div>
        ...
        <section className="settings-card">
          <div className="settings-card-header">
            ...
            <p>
              Choose how ThreatLens AI should
              appear.
            </p>
          </div>
        ...
        <section className="settings-card">
          <div className="settings-card-header">
            ...
            <p>
              Preview and use the workspace
              layout for your preferred device
              size.
            </p>
          </div>
        ...
        <section className="settings-card">
          <div className="settings-card-header">
            ...
            <p>
              Current workspace: {themeMode}{' '}
              mode · {deviceMode} layout
            </p>
          </div>

          <div className="settings-preview">
            <div
              className={`settings-preview-frame ${deviceMode}`}
            >
      ...
      <main className="dashboard-content">
        <header className="dashboard-header">
          <div>
            ...
            <p className="welcome-text">
              Manage your ThreatLens AI analyst
